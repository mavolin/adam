...
import (
	...
	"github.com/mavolin/adam/_examples/localized_bot/plugins/say"
...
func main() {
	b, err := bot.New(bot.Options{
		...
		// If you wanted to fully enable localization, you would have to use a
		// custom bot.SettingsProvider that returns a i18n.Func for the
