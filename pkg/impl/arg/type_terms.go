...
var (
	switchName        = i18n.NewFallbackConfig("arg.types.switch.name", "Switch")
	switchDescription = i18n.NewFallbackConfig(
		"arg.types.switch.description",
...
var switchWithContentError = i18n.NewFallbackConfig(
	"arg.types.switch.error.with_content",
...
var (
	choiceName        = i18n.NewFallbackConfig("arg.types.choice.name", "Choice")
	choiceDescription = i18n.NewFallbackConfig(
		"arg.types.choice.name",
...
var choiceInvalidError = i18n.NewFallbackConfig(
	"arg.types.choice.error.invalid", "`{{.raw}}` is not a valid choice.")
...
var (
	integerName        = i18n.NewFallbackConfig("arg.types.integer.name", "Integer")
	integerDescription = i18n.NewFallbackConfig("arg.types.integer.description", "A whole number.")
)

// ================================ Decimal Meta Data ================================

var (
	decimalName        = i18n.NewFallbackConfig("arg.types.decimal.name", "Decimal")
	decimalDescription = i18n.NewFallbackConfig("arg.types.decimal.description", "A decimal number.")
)

// ================================ Integer Errors ================================

var integerSyntaxError = i18n.NewFallbackConfig("arg.types.integer.error.syntax", "`{{.raw}}` is not an integer.")

// ================================ Decimal Errors ================================

var decimalSyntaxError = i18n.NewFallbackConfig("arg.types.decimal.error.syntax", "`{{.raw}}` is not a decimal.")

// ================================ Shared Errors ================================

var (
	numberBelowRangeError = i18n.NewFallbackConfig(
		"arg.types.number.error.under_range",
		"`{{.raw}}` is too small, try using a larger number.")
	numberOverRangeError = i18n.NewFallbackConfig(
		"arg.types.number.error.over_range.arg",
		"`{{.raw}}` is too large, try using a smaller number.")

	numberBelowMinErrorArg = i18n.NewFallbackConfig(
		"arg.types.number.error.below_min.arg",
		"Argument {{.position}} may be no smaller than {{.min}}.")
	numberBelowMinErrorFlag = i18n.NewFallbackConfig(
		"arg.types.number.error.below_min.flag",
...
var (
	durationName        = i18n.NewFallbackConfig("arg.types.duration.name", "Duration")
	durationDescription = i18n.NewFallbackConfig(
		"arg.types.duration.description", "A timespan. For example: 1h 3 min 4s.\n"+
...
var (
	timeName        = i18n.NewFallbackConfig("arg.types.time.name", "Time")
...
var (
	timeInvalidErrorArg = i18n.NewFallbackConfig(
		"arg.types.time.error.invalid.arg",
	...
	timeInvalidErrorFlag = i18n.NewFallbackConfig(
		"arg.types.time.error.invalid.flag",
	...
	timeRequireUTCOffsetErrorArg = i18n.NewFallbackConfig(
		"arg.types.time.error.require_utc_offset.arg",
...
var (
	dateName        = i18n.NewFallbackConfig("arg.types.date.name", "Date")
	dateDescription = i18n.NewFallbackConfig(
		"arg.types.date.description",
...
var (
	dateInvalidErrorArg = i18n.NewFallbackConfig(
		"arg.types.date.error.invalid.arg",
	...
	dateInvalidErrorFlag = i18n.NewFallbackConfig(
		"arg.types.date.error.invalid.flag",
	...
	dateRequireUTCOffsetErrorArg = i18n.NewFallbackConfig(
		"arg.types.date.error.require_utc_offset.arg",
...
var (
	dateTimeName        = i18n.NewFallbackConfig("arg.types.date_time.name", "Date and Time")
	dateTimeDescription = i18n.NewFallbackConfig(
		"arg.types.date_time.description",
...
var (
	dateTimeInvalidErrorArg = i18n.NewFallbackConfig(
		"arg.types.date_time.error.invalid.arg",
	...
	dateTimeInvalidErrorFlag = i18n.NewFallbackConfig(
		"arg.types.date_time.error.invalid.flag",
...
var (
	timeZoneName        = i18n.NewFallbackConfig("arg.types.time_zone.name", "Time Zone")
	timeZoneDescription = i18n.NewFallbackConfig(
		"arg.types.time_zone.description",
...
var timeZoneInvalidError = i18n.NewFallbackConfig(
	"arg.types.time_zone.error.invalid", "`{{.raw}}` is not a valid IANA time zone name.")
...
var (
	textName        = i18n.NewFallbackConfig("arg.types.text.name", "Text")
	textDescription = i18n.NewFallbackConfig("arg.types.text.description", "A text.")
)
...
var (
	codeName        = i18n.NewFallbackConfig("arg.types.code.name", "Code")
	codeDescription = i18n.NewFallbackConfig("arg.types.code.description", "A code block.")
)
...
var (
	codeInvalidErrorArg = i18n.NewFallbackConfig(
		"arg.types.code.error.invalid.arg", "Argument {{.position}} is not a valid code block.")
	codeInvalidErrorFlag = i18n.NewFallbackConfig(
		"arg.types.code.error.invalid.flag", "The `{{.used_name}}`-flag doesn't contain a valid code block.")
)
...
var (
	linkName        = i18n.NewFallbackConfig("arg.types.link.name", "Link")
	linkDescription = i18n.NewFallbackConfig("arg.types.link.description", "A link to something.")
)
...
var (
	linkInvalidErrorArg = i18n.NewFallbackConfig(
		"arg.types.link.error.invalid.arg", "The link in argument {{.position}} is not valid.")
	linkInvalidErrorFlag = i18n.NewFallbackConfig(
		"arg.types.link.error.invalid.flag", "The link used as `{{.used_name}}`-flag is not valid.")
)
...
var (
	idName        = i18n.NewFallbackConfig("arg.types.id.name", "ID")
	idDescription = i18n.NewFallbackConfig("arg.types.id.name", "An id.")
)
...
var (
	emojiName = i18n.NewFallbackConfig("arg.types.emoji.name", "Emoji")

	emojiDescriptionNoID   = i18n.NewFallbackConfig("arg.types.emoji.description.no_id", "An emoji. "+emojiutil.Ghost)
	emojiDescriptionWithID = i18n.NewFallbackConfig(
		"arg.types.emoji.description.with_id", "An emoji or the id of an emoji. "+emojiutil.Ghost)
)

// ================================ Errors ================================

var (
	emojiInvalidError = i18n.NewFallbackConfig("arg.types.emoji.error.invalid", "`{{.raw}}` is not an emoji.")

	emojiCustomEmojiInDMError = i18n.NewFallbackConfig(
		"arg.types.emoji.error.custom_emoji_in_dm", "You can't use custom emojis in DMs.")

	emojiCustomEmojiErrorArg = i18n.NewFallbackConfig(
		"arg.types.emoji.error.custom_emoji.arg",
		"You can't use a custom emoji as argument {{.position}}.")
	emojiCustomEmojiErrorFlag = i18n.NewFallbackConfig(
		"arg.types.emoji.error.custom_emoji.flag",
		"You can't use a custom emoji as `{{.used_name}}`-flag.")

	emojiNoAccessError = i18n.NewFallbackConfig(
		"arg.types.user.error.no_access",
	...
	emojiIDNoAccessError = i18n.NewFallbackConfig(
		"arg.types.emoji.error.id_no_access",
...
var (
	memberName = i18n.NewFallbackConfig("arg.types.member.name", "Member")

	memberDescriptionNoIDs = i18n.NewFallbackConfig(
		"arg.types.member.description.no_ids", "A mention of a user in a server. For example @Wumpus.")
	memberDescriptionWithIDs = i18n.NewFallbackConfig(
		"arg.types.member.description.with_ids",
...
var (
	userName        = i18n.NewFallbackConfig("arg.types.user.name", "User")
	userDescription = i18n.NewFallbackConfig(
		"arg.types.user.description",
...
var (
	userInvalidError = i18n.NewFallbackConfig("arg.types.user.error.invalid", "`{{.raw}}` is not a user.")

	userIDInvalidError = i18n.NewFallbackConfig(
		"arg.types.user.error.id_invalid", "`{{.raw}}` is not a valid user id.")

	userInvalidMentionWithRawError = i18n.NewFallbackConfig(
		"arg.types.user.error.invalid_mention_with_raw", "{{.raw}} is not a valid user mention.")

	userInvalidMentionErrorArg = i18n.NewFallbackConfig(
		"arg.types.user.error.invalid_mention.arg",
	...
	userInvalidMentionErrorFlag = i18n.NewFallbackConfig(
		"arg.types.user.error.invalid_mention.flag",
...
var (
	roleName = i18n.NewFallbackConfig("arg.types.role.name", "Role")

	roleDescriptionNoID = i18n.NewFallbackConfig(
		"arg.types.role.description.no_id", "A role mention. For example @WumpusGang.")
	roleDescriptionWithID = i18n.NewFallbackConfig(
		"arg.types.role.description.with_id",
...
var (
	roleInvalidError = i18n.NewFallbackConfig("arg.types.role.error.invalid", "`{{.raw}}` is not a role.")

	roleIDInvalidError = i18n.NewFallbackConfig(
		"arg.types.role.error.id_invalid", "`{{.raw}}` is not a valid role id.")

	roleInvalidMentionWithRawError = i18n.NewFallbackConfig(
		"arg.types.role.error.invalid_mention_with_raw", "{{.raw}} is not a valid role mention.")

	roleInvalidMentionErrorArg = i18n.NewFallbackConfig(
		"arg.types.role.error.invalid_mention.arg",
	...
	roleInvalidMentionErrorFlag = i18n.NewFallbackConfig(
		"arg.types.role.error.invalid_mention.flag",
...
var channelIDInvalidError = i18n.NewFallbackConfig(
	"arg.types.channel.error.id_invalid",
...
var (
	textChannelName = i18n.NewFallbackConfig("arg.types.text_channel.name", "Text Channel")

	textChannelDescriptionNoID = i18n.NewFallbackConfig(
		"arg.types.text_channel.description.no_id",
		"A mention of a text or announcement channel.")
	textChannelDescriptionWithID = i18n.NewFallbackConfig(
		"arg.types.text_channel.description.with_id",
...
var (
	textChannelInvalidError = i18n.NewFallbackConfig(
		"arg.types.text_channel.error.invalid", "`{{.raw}}` is not a valid id channel.")

	textChannelInvalidMentionWithRawError = i18n.NewFallbackConfig(
		"arg.types.text_channel.error.invalid_mention_with_raw",
		"`{{.raw}}` is not a valid mention of a id channel.")

	textChannelInvalidMentionErrorArg = i18n.NewFallbackConfig(
		"arg.types.text_channel.error.invalid_mention.arg",
	...
	textChannelInvalidMentionErrorFlag = i18n.NewFallbackConfig(
		"arg.types.text_channel.error.invalid_mention.flag",
...
var (
	categoryName        = i18n.NewFallbackConfig("arg.types.category.name", "Category")
	categoryDescription = i18n.NewFallbackConfig(
		"arg.types.category.description",
...
var (
	categoryChooserTitle = i18n.NewFallbackConfig("arg.types.category.chooser.title", "Multiple Matches")

	categoryChooserDescription = i18n.NewFallbackConfig(
		"arg.types.category.chooser.description",
...
var (
	categoryNotFoundError = i18n.NewFallbackConfig(
		"arg.types.category.error.not_found",
	...
	categoryTooManyPartialMatchesError = i18n.NewFallbackConfig(
		"arg.types.category.error.too_many_partial_matches",
		"There are too many categories that match `{{.raw}}`. "+
...
var (
	voiceChannelName        = i18n.NewFallbackConfig("arg.types.voice_channel.name", "Voice Channel")
	voiceChannelDescription = i18n.NewFallbackConfig(
		"arg.types.voice_channel.description",
...
var (
	voiceChannelNotFoundError = i18n.NewFallbackConfig(
		"arg.types.voice_channel.error.not_found",
	...
	voiceChannelTooManyPartialMatchesError = i18n.NewFallbackConfig(
		"arg.types.voice_channel.error.too_many_partial_matches",
		"There are too many categories that match `{{.raw}}`. "+
...
var (
	commandName        = i18n.NewFallbackConfig("arg.types.command.name", "Command")
	commandDescription = i18n.NewFallbackConfig(
		"arg.types.command.description", "The name of a command without it's prefix.")
)
...
var (
	moduleName        = i18n.NewFallbackConfig("arg.types.module.name", "Module")
	moduleDescription = i18n.NewFallbackConfig(
		"arg.types.module.description",
...
var (
	pluginName        = i18n.NewFallbackConfig("arg.types.plugin.name", "Command or Module")
	pluginDescription = i18n.NewFallbackConfig(
		"arg.types.plugin.description",
...
var (
	regexpName        = i18n.NewFallbackConfig("arg.types.regular_expression.name", "Regular Expression")
	regexpDescription = i18n.NewFallbackConfig(
		"arg.types.regular_expression.description",
...
var (
	...
	regexpInvalidCharClassErrorFlag = i18n.NewFallbackConfig(
		"arg.types.regular_expression.error.invalid_character_class.flag",
	...
	regexpInvalidCharRangeErrorArg = i18n.NewFallbackConfig(
		"arg.types.regular_expression.error.invalid_character_range.arg",
	...
	regexpInvalidCharRangeErrorFlag = i18n.NewFallbackConfig(
		"arg.types.regular_expression.error.invalid_character_range.flag",
	...
	regexpInvalidEscapeErrorArg = i18n.NewFallbackConfig(
		"arg.types.regular_expression.error.invalid_escape.arg",
	...
	regexpInvalidEscapeErrorFlag = i18n.NewFallbackConfig(
		"arg.types.regular_expression.error.invalid_escape.flag",
	...
	regexpInvalidNamedCaptureErrorArg = i18n.NewFallbackConfig(
		"arg.types.regular_expression.error.invalid_named_capture.arg",
	...
	regexpInvalidNamedCaptureErrorFlag = i18n.NewFallbackConfig(
		"arg.types.regular_expression.error.invalid_named_capture.flag",
	...
	regexpInvalidPerlOpErrorArg = i18n.NewFallbackConfig(
		"arg.types.regular_expression.error.invalid_perl_operation.arg",
	...
	regexpInvalidPerlOpErrorFlag = i18n.NewFallbackConfig(
		"arg.types.regular_expression.error.invalid_perl_operation.flag",
	...
	regexpInvalidRepeatOpErrorArg = i18n.NewFallbackConfig(
		"arg.types.regular_expression.error.invalid_repeat_operation.arg",
		"The regular expression in argument {{.position}} has two consecutive `+`.")
	regexpInvalidRepeatOpErrorFlag = i18n.NewFallbackConfig(
		"arg.types.regular_expression.error.invalid_repeat_operation.flag",
	...
	regexpInvalidRepeatSizeErrorArg = i18n.NewFallbackConfig(
		"arg.types.regular_expression.error.invalid_repeat_size.arg",
	...
	regexpInvalidRepeatSizeErrorFlag = i18n.NewFallbackConfig(
		"arg.types.regular_expression.error.invalid_repeat_size.flag",
	...
	regexpMissingParenErrorArg = i18n.NewFallbackConfig(
		"arg.types.regular_expression.error.missing_parentheses.arg",
		"The regular expression in argument {{.position}} is missing a closing `)`:\n```\n{{.expression}}\n```")
	regexpMissingParenErrorFlag = i18n.NewFallbackConfig(
		"arg.types.regular_expression.error.missing_parentheses.flag",
		"The regular expression you used in the `{{.used_name}}`-flag is missing a closing `)`:\n"+
			"```\n{{.expression}}\n```")

	regexpMissingRepeatArgErrorArg = i18n.NewFallbackConfig(
		"arg.types.regular_expression.error.missing_repeat_argument.arg",
	...
	regexpMissingRepeatArgErrorFlag = i18n.NewFallbackConfig(
		"arg.types.regular_expression.error.missing_repeat_argument.flag",
	...
	regexpTrailingBackslashErrorArg = i18n.NewFallbackConfig(
		"arg.types.regular_expression.error.trailing_backslash.arg",
	...
	regexpTrailingBackslashErrorFlag = i18n.NewFallbackConfig(
		"arg.types.regular_expression.error.trailing_backslash.flag",
	...
	regexpUnexpectedParenErrorArg = i18n.NewFallbackConfig(
		"arg.types.regular_expression.error.unexpected_parentheses.arg",
		"The regular expression in argument {{.position}} has an unexpected `)`:\n```\n{{.expression}}\n```")
	regexpUnexpectedParenErrorFlag = i18n.NewFallbackConfig(
		"arg.types.regular_expression.error.unexpected_parentheses.flag",
