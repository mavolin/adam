...
func TestNSFW(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			expect: newInvalidChannelTypeError(plugin.GuildChannels, i18n.FallbackLocalizer, true),
		},
		{
			name: "nsfw",
			ctx: &plugin.Context{
...
func TestAllRoles(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			expect: newAllMissingRolesError([]discord.Role{{ID: 456}}, i18n.FallbackLocalizer),
		},
		{
...
func TestAnyRole(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			expect: newAnyMissingRolesError([]discord.Role{{ID: 456}}, i18n.FallbackLocalizer),
		},
		{
			name:    "missing - can manage",
			allowed: []discord.RoleID{123, 456},
...
func TestChannels(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			expect: newChannelsError([]discord.ChannelID{456}, i18n.FallbackLocalizer),
		},
		{
