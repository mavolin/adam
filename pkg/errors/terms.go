...
var (
	internalErrorTitle = i18n.NewFallbackConfig("common.error.internal.title", "Internal Error")

	defaultInternalDesc = i18n.NewFallbackConfig("common.error.internal.description.default",
...
var (
	discordErrorFeatureTemporarilyDisabled = i18n.NewFallbackConfig(
		"common.error.discord.feature_temporarily_disabled",
