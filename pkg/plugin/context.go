...
// ErrInsufficientSendPermissions is an errors.InformationalError that signals
// that a message wasn't sent, because the bot lacks permissions.
// This error should not be handled.
//
// Note for development
//
// The value generated by the stdlib's errors.New is merely a placeholder to
// make sure all user generated code runs smoothly.
// If the code loads adam's error package, the value will be replaced with:
//
//		var ErrInsufficientSendPermissions = errors.NewInformationalError("insufficient permissions to send message")
//
// Refer to errors.informational_error.go init() for more information.
//
// TL;DR: Don't handle this error other than any other
// errors.InformationalError.
var ErrInsufficientSendPermissions = errors.New("insufficient permissions to send message")
